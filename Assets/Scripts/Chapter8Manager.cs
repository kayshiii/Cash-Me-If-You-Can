...
public class Chapter8Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public GameObject cutsceneEndPanel;     // second cutscene (before report)
    ...
    public DialogueLine[] chapter8IntroLines;   // intro dialogue
    public DialogueLine[] chapter8MidLines;     // mid dialogue (after budget)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 8, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter8IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget8()
    }
    ...
    // Called by BudgetPanelManager when Chapter 8 budget is confirmed
    public void ProceedAfterBudget8()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter8MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 8 complete. Showing post-level report.");
    }
