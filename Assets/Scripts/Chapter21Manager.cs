...
public class Chapter21Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter21IntroLines;   // intro dialogue
    public DialogueLine[] chapter21MidLines;     // mid dialogue (after budget)
    public DialogueLine[] chapter21FinalLines;   // final dialogue (after random event)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 21, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter21IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget21()
    }
    ...
    // === Called by BudgetPanelManager when Chapter 21 budget is confirmed ===
    public void ProceedAfterBudget21()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter21MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void OnRandomEventChoicePay()
    {
    ...
    IEnumerator ContinueAfterRandomEvent()
    {
        ...
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter21FinalLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 21 complete. Showing post-level report.");
    }
