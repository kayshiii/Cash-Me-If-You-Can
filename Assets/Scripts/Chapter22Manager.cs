...
public class Chapter22Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter22IntroLines;   // intro dialogue
    public DialogueLine[] chapter22MidLines;     // mid dialogue (after budget)
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter22IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget22()
    }
    ...
    // Called by BudgetPanelManager when Chapter 22 budget is confirmed
    public void ProceedAfterBudget22()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter22MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 22 complete. Showing post-level report.");
    }
