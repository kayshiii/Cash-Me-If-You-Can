...
public class Chapter14Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter14IntroLines;   // intro dialogue
    public DialogueLine[] chapter14MidLines;     // mid dialogue (after budget)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 14, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter14IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget14()
    }
    ...
    // === Called by BudgetPanelManager when Chapter 14 budget is confirmed ===
    public void ProceedAfterBudget14()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter14MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void OnRandomEventChoiceAttend()
    {
        GameManager.Instance.AddBudget(-500);
        GameManager.Instance.AddSocial(15);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 14 complete. Showing post-level report.");
    }
