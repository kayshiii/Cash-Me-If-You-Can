...
public class Chapter20Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter20IntroLines;   // intro dialogue
    public DialogueLine[] chapter20MidLines;     // mid dialogue (after budget)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 20, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter20IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget20()
    }
    ...
    // === Called by BudgetPanelManager when Chapter 20 budget is confirmed ===
    public void ProceedAfterBudget20()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter20MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void OnRandomEventChoiceVisit()
    {
    ...
    public void OnRandomEventChoicePass()
    {
        GameManager.Instance.AddFocus(-30);
        GameManager.Instance.AddHappiness(-20);
        CloseRandomEventAndContinue();
    }
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 20 complete. Showing post-level report.");
    }
