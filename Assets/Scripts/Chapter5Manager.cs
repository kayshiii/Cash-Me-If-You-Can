...
public class Chapter5Manager : MonoBehaviour
{
    ...
    public GameObject cutsceneIntroPanel;     // first cutscene (A)
    public GameObject cutsceneMidPanel;       // second cutscene (B)
    ...
    public DialogueLine[] chapter5IntroLines;   // intro dialogue
    public DialogueLine[] chapter5MidLines;     // mid dialogue (after budget)
    public DialogueLine[] chapter5FinalLines;   // final dialogue (after 2nd cutscene)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 5, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter5IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait until BudgetPanelManager calls ProceedAfterBudget5()
    }
    ...
    // Called by BudgetPanelManager when Chapter 5 budget is confirmed
    public void ProceedAfterBudget5()
    {
    ...
    {
        Debug.Log("Budget confirmed. Proceeding to mid dialogue and cutscene.");
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter5MidLines));
        ...
        // 6) Final dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter5FinalLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 5 complete. Showing post-level report.");
    }
