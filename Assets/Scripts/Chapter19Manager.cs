...
public class Chapter19Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter19IntroLines;   // intro dialogue
    public DialogueLine[] chapter19MidLines;     // mid dialogue (after budget)
    ...
    void Start()
    {
        ...
        Debug.Log($"[Level Start] Chapter 19, Budget: {startingBudget}");
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter19IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget19()
    }
    ...
    // Called by BudgetPanelManager when Chapter 19 budget is confirmed
    public void ProceedAfterBudget19()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter19MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 19 complete. Showing post-level report.");
    }
