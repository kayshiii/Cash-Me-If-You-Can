...
public class Chapter24Manager : MonoBehaviour
{
    [Header("Intro")]
    ...
    public DialogueLine[] chapter24IntroLines;   // intro dialogue
    public DialogueLine[] chapter24MidLines;     // mid dialogue (after budget)
    ...
    IEnumerator MainFlow()
    {
        ...
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter24IntroLines));
        dialoguePanel.SetActive(false);

        // 3) Budget screen
        ShowBudgetPanel();
        // Wait for BudgetPanelManager to call ProceedAfterBudget24()
    }
    ...
    // Called by BudgetPanelManager when Chapter 24 budget is confirmed
    public void ProceedAfterBudget24()
    {
    ...
    IEnumerator AfterBudgetFlow()
    {
        ...
        // 4) Mid dialogue
        dialoguePanel.SetActive(true);
        yield return StartCoroutine(dialogueManager.PlayDialogueSequence(chapter24MidLines));
        dialoguePanel.SetActive(false);
    ...
    public void LevelEndReport()
    {
        ...
        Debug.Log("Chapter 24 complete. Showing post-level report.");
    }
